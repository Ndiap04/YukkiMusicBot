...
from .play import (audio_markup, audio_markup2, audio_timer_markup_start,
                   ...
                   secondary_markup, timer_markup, url_markup, url_markup2)
...
from .start import (custommarkup, dashmarkup, private_panel, setting_markup,
                    start_pannel, uptime_pannel, welcome_pannel, usermarkup, volmarkup, settings_pannel, pemilik_pannel, sudo_pannel)
