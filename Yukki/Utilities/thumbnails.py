...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    image2 = Image.open(f"Utils/20220106_184217.png")
    ...
    draw.text((27, 538), f"Playing on: {ctitle[:14]}...", fill= "white", stroke_width = 1, stroke_fill="white", font=font2)
    draw.text((27, 612), f"{title[:27]}...", fill="white", stroke_width = 2, stroke_fill="white" ,font=font)
