...
async def admin_risghts(_, CallbackQuery):
    ...
    if command == "pausecb":
        ...
        await CallbackQuery.message.reply_text(
            f"⏸ Music Telah Dipause Oleh {CallbackQuery.from_user.mention}!",
    ...
    if command == "resumecb":
        ...
        await CallbackQuery.message.reply_text(
            f"▶️ Music Telah Dilanjutkan Oleh {CallbackQuery.from_user.mention}!",
            reply_markup=audio_markup2,
        )
        await CallbackQuery.message.delete()
    ...
    if command == "stopcb":
        ...
        await CallbackQuery.message.reply_text(
            f"⏹ Music Telah Dihentikan Oleh {CallbackQuery.from_user.mention}!",
            reply_markup=audio_markup2,
        )
        await CallbackQuery.message.delete()
...
async def group_playlist(_, CallbackQuery):
    ...
    return await CallbackQuery.message.reply_text(
        f"✔️ Ditambahkan ke {type}'s {genre}!\n • **Playlist by** : {CallbackQuery.from_user.mention}"
    )
